...
Route::group(['as' => 'student.'], function () {
    ...
    Route::post('change-password', [DashboardController::class, 'changePasswordUpdate'])->name('changePasswordUpdate')->middleware('isDemo');;
    ...
    Route::post('subscription/pay', [SubscriptionController::class, 'pay'])->name('subscription.pay')->middleware('isDemo');
