...
class InstructorController extends Controller
{
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $request->validate([
            ...
            'professional_title' => 'required',
            'area_code' => 'required',
            'phone_number' => 'bail|numeric|digits_between:10,14|unique:users,mobile_number,'.$instructor->user_id,
            'address' => 'required',
            'gender' => 'required',
            'about_me' => 'required',
            'image' => 'mimes:jpeg,png,jpg|file|dimensions:min_width=300,min_height=300,max_width=300,max_height=300|max:1024'
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('success', __('Instructor Deleted Successfully'));
        return redirect()->back();
    }
