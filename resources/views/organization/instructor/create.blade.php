...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> {{ __('Add Instructor') }} </h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('Add Instructor') }}</li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content')
    <div class="instructor-profile-right-part">
        <form method="POST" action="{{ route('organization.instructor.store') }}" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            <div class="instructor-profile-info-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <input type="text" name="social_link[facebook]" value="{{ old("social_link")['facebook'] ?? '' }}"
                            placeholder="https://facebook.com" class="form-control">
                    </div>
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{ __('Twitter') }}</label>
                        <input type="text" name="social_link[twitter]" value="{{ old("social_link")['twitter'] ?? '' }}" class="form-control"
                            placeholder="https://twitter.com">

                    </div>
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{ __('Linkedin') }}</label>
                        <input type="text" name="social_link[linkedin]" value="{{ old("social_link")['linkedin'] ?? '' }}" class="form-control"
                            placeholder="https://linkedin.com">
                    </div>
                    <div class="col-md-6 mb-30">
                        <label class="font-medium font-15 color-heading">{{ __('Pinterest') }}</label>
                        <input type="text" name="social_link[pinterest]" value="{{ old("social_link")['pinterest'] ?? '' }}" class="form-control"
