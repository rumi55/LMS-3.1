...
class StudentController extends Controller
{
    ...
    public function view($uuid)
    {
        ...
        $data['enrollments'] = Enrollment::where('user_id', $data['student']->user_id)->latest()->paginate(15);
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $request->validate([
            ...
            'area_code' => 'required',
            'phone_number' => 'bail|numeric|digits_between:10,14|unique:users,mobile_number,'.$student->user_id,
            'address' => 'required',
            'gender' => 'required',
            'about_me' => 'required',
            'image' => 'mimes:jpeg,png,jpg|file|dimensions:min_width=300,min_height=300,max_width=300,max_height=300|max:1024'
