                            ...
                            <div class="col-12 col-md-7 col-lg-7 col-xl-8">
                                ...
                                <div style="overflow: hidden; height: 0;">
                                    <div id="certificate-preview-div-hidden"
                                        ...
                                        <img src="{{asset('frontend/assets/img/certificate.jpg')}}" alt="img"
                                            class="sample-certificate-img-show img-fluid">
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 col-md-5 col-lg-5 col-xl-4">
                                <form method="POST" id="certificate-form" action="{{route('certificate.store')}}"
                                                    ...
                                                    <div class="create-certificate-browse-file form-control mb-2">
                                                        <div>
                                                            <input type="file" name="background_image" accept="image/*"
                                                                class="form-control" title="Browse Image File" required>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker3" class="mb-0">
                                                                            <input type="color" name="number_font_color"
                                                                                value="{{old('number_font_color') ? : '#363234'}}"
                                                                                id="colorPicker3">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker4" class="mb-0">
                                                                            <input type="color" name="title_font_color"
                                                                                value="{{old('title_font_color') ? : '#363234' }} "
                                                                                id="colorPicker4">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12 mb-15">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input class="form-check-input" type="radio"
                                                                                name="show_date"
                                                                                {{old('show_date')=='yes' ? 'checked'
                                                                                : '' }} id="show_date_yes" value="yes">
                                                                            <label
                                                                                class="form-check-label mb-0 color-heading"
                                                                                for="show_date_yes">{{ __('Yes')
                                                                                }}</label>
                                                                        </div>
                                                                        <div
                                                                            class="form-check mb-0 d-flex align-items-center">
                                                                            <input class="form-check-input" type="radio"
                                                                                ...
                                                                                value="no" {{old('show_date')=='no'
                                                                                ? 'checked' : '' }}>
                                                                            <label
                                                                                class="form-check-label mb-0 color-heading"
                                                                                for="exampleRadios2">{{ __('No')
                                                                                }}</label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker5" class="mb-0">
                                                                            <input type="color" name="date_font_color"
                                                                                value="{{old('date_font_color') ? : '#363234'}}"
                                                                                id="colorPicker5">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-15">
                                                                    ...
                                                                    <input type="number" min="0"
                                                                        ...
                                                                        value="{{old('student_name_x_position')}}"
                                                                        class="form-control" placeholder="0">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-15">
                                                                    ...
                                                                    <input type="number" min="0"
                                                                        ...
                                                                        value="{{old('student_name_y_position')}}"
                                                                        class="form-control" placeholder="30">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-15">
                                                                    ...
                                                                    <input type="number" min="1"
                                                                        ...
                                                                        value="{{old('student_name_font_size')}}"
                                                                        class="form-control" placeholder="20">
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker6" class="mb-0">
                                                                            <input type="color"
                                                                                ...
                                                                                value="{{old('student_name_font_color') ? : '#363234'}}"
                                                                                id="colorPicker6">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker1" class="mb-0">
                                                                            <input type="color" name="body_font_color"
                                                                                value="{{old('body_font_color') ? : '#363234'}}"
                                                                                id="colorPicker1">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-15">
                                                                    ...
                                                                    <input type="number" min="0"
                                                                        ...
                                                                        value="{{old('role_1_y_position')}}"
                                                                        class="form-control" placeholder="55">
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker2" class="mb-0">
                                                                            <input type="color" name="role_1_font_color"
                                                                                value="{{old('role_1_font_color') ? : '#363234'}}"
                                                                                id="colorPicker2">
                                                                        </label>
                                                                    </span>
                                                                </div>
                                                                    ...
                                                                    <span class="color-picker">
                                                                        <label for="colorPicker7" class="mb-0">
                                                                            <input type="color" name="role_2_font_color"
                                                                                value="{{old('role_2_font_color') ? : '#363234'}} "
                                                                                id="colorPicker7">
                                                                        </label>
                                                                    </span>
                                                                </div>
