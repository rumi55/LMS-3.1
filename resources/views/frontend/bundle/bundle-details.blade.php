            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="share-course-list">
                        <li><a href="http://www.facebook.com/sharer.php?u={{ route('bundle-details', [$bundle->uuid, $bundle->slug]) }}"><span class="iconify"
                                                                                                                                               data-icon="cib:facebook-f"></span></a>
                        </li>
                        <li><a href="https://twitter.com/share?url={{ route('bundle-details', [$bundle->uuid, $bundle->slug]) }}"><span class="iconify"
                                                                                                                                        data-icon="el:twitter"></span></a></li>
                        <li><a href="https://www.linkedin.com/shareArticle?url={{ route('bundle-details', [$bundle->uuid, $bundle->slug]) }}"><span class="iconify"
