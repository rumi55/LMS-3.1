    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14"><a href="{{ route('organization.certificate.index') }}">{{__('Manage Certificate')}}</a></li>
        ...
        <div class="instructor-quiz-list-page instructor-certificate-template-page">
            ...
            <div class="row">
                ...
                <div class="col-12 inner-next-btn-wrap">
                    <form method="post" action="{{route('organization.certificate.setForCreate', [$course->uuid])}}">
                        @csrf
