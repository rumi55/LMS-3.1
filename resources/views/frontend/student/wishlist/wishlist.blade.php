                            ...
                            <div class="card course-item wishlist-item border-0 d-flex align-items-center">
                                <div class="course-img-wrap flex-shrink-0 overflow-hidden">
                                    ...
                                    @elseif($wishlist->bundle_id)
                                        <a href="{{ route('bundle-details', [@$wishlist->bundle->uuid, @$wishlist->bundle->slug]) }}"><img src="{{ getImageFile(@$wishlist->bundle->image) }}" alt="bundle course" class="img-fluid"></a>
                                    @endif
                                </div>
                                <div class="card-body flex-grow-1">
                                    <h5 class="card-title course-title">
                                        ...
                                        @elseif($wishlist->bundle_id)
                                            <a href="{{ route('bundle-details', [@$wishlist->bundle->uuid, @$wishlist->bundle->slug]) }}">{{ @$wishlist->bundle->name }}</a>
                                        @endif
                                    </h5>
                                    <p class="card-text instructor-name-certificate font-medium">
                                        ...
                                        @elseif($wishlist->bundle_id)
                                            ...
                                            @if(get_instructor_ranking_level(@$wishlist->course->bundle->user->badges))
                                                | {{ get_instructor_ranking_level(@$wishlist->course->bundle->user->badges) }}
                                            @endif
                                        @endif
