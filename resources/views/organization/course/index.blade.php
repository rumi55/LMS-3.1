                                ...
                                <div class="instructor-my-course-item-left">
                                    ...
                                    <div class="course-item-bottom">
                                        ...
                                        <div class="instructor-my-courses-btns d-inline-flex">
                                            <a href="{{route('organization.course.edit', [$course->uuid])}}" class="para-color font-14 font-medium d-flex align-items-center"><span class="iconify" data-icon="bx:bx-edit"></span>Edit</a>
