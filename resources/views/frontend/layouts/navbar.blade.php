                            ...
                            <div class="dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end'}}"
                                ...
                                <ul class="user-dropdown-item-box">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('student.wishlist') }}"><span
                                                class="iconify" data-icon="bx:bx-heart"></span>{{__('Wishlist')}}</a>
                                    </li>
                                    @if(get_option('subscription_mode'))
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.subscription_panel') }}"><span
                                                class="iconify" data-icon="akar-icons:desktop-device"></span>
                                            {{ __('Subscription Panel') }}</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.subscription_plan') }}"><span
                                                class="iconify" data-icon="eos-icons:subscriptions-created"></span>
                                ...
                                <ul class="user-dropdown-item-box">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.all_login_device') }}"><span
                                                class="iconify" data-icon="akar-icons:desktop-device"></span>
                                            {{ __('Device Control') }}</a>
                                    </li>
                                    @endif
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('wallet./') }}"><span class="iconify"
                                ...
                                <ul class="user-dropdown-item-box">
                                    <li>
                                        <a class="dropdown-item" href="{{route('affiliate.become-an-affiliate')}}"><span
