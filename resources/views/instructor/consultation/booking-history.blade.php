                ...
                <div class="col-12">
                    <ul class="nav nav-tabs assignment-nav-tabs live-class-list-nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ @$upcomingActive }}" id="upcoming-tab" data-bs-toggle="tab" data-bs-target="#upcoming" type="button" role="tab"
                                    aria-controls="upcoming" aria-selected="true">{{ __('Upcoming') }}
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ @$completedActive }}" id="past-tab" data-bs-toggle="tab" data-bs-target="#past" type="button" role="tab" aria-controls="past"
                                    aria-selected="false">{{ __('Completed') }}
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ @$cancelledActive }}" id="past-tab" data-bs-toggle="tab" data-bs-target="#cancelled" type="button" role="tab"
                                    aria-controls="cancelled" aria-selected="false">{{ __('Cancelled') }}
                            </button>
                        </li>
                    </ul>

                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade {{ @$upcomingShowActive }}" id="upcoming" role="tabpanel" aria-labelledby="upcoming-tab">
                                    ...
                                    @foreach($bookingHistoryUpcoming as $upcoming)
                                        ...
                                        <tr>
                                                ...
                                                <div class="table-data-with-img d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="instructor-student-img-wrap radius-50">
                                                            <img src="{{ getImageFile(@$upcoming->user->image_path) }}" alt="img" class="img-fluid"></div>
                                                    </div>
                                                    <div class="flex-grow-1 table-data-course-name">{{ @$upcoming->user->student->name }}</div>
                                                </div>
                                            </td>
                                            <td>{{ $upcoming->date }}</td>
                                            <td>{{ $upcoming->time }}</td>
                                            ...
                                            <td>
                                                <div class="booking-table-detail-btn quiz-details-action-btns">
                                                    <button data-meeting_host_name="{{ $upcoming->meeting_host_name }}" data-id="{{ $upcoming->id }}" class="collapsed create_link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample{{ $upcoming->id }}"
                                                            aria-expanded="false" aria-controls="collapseExample{{ $upcoming->id }}" title="See Details">
                                            ...
                                            <td>
                                                <div class="red-blue-action-btns">
                                                    <button type="button" data-route="{{ route('instructor.bookingStatus', [$upcoming->uuid, 3]) }}"
                                        ...
                                        <tr class="show-details-content">
                                            <td class="p-0" colspan="7">
                                                <div id="collapseExample{{ $upcoming->id }}" class="booking-history-details accordion-collapse collapse"
                                                     aria-labelledby="collapseExample{{ $upcoming->id }}" data-bs-parent="#accordionExample">
                                                    @if($upcoming->type == 1)
                                                        <div class="booking-history-details-wrap align-items-center p-20">
                                                            <div class="booking-history-left">
                                                                ...
                                                                <hr>
                                                                <p><h6 class="font-15 d-inline">{{ __('Name') }}</h6>: {{ @$upcoming->user->student->name }}</p>
                                                                <p><h6 class="font-15 d-inline">{{ __('Email') }}</h6>: {{ @$upcoming->user->email }}</p>
                                                                <p><h6 class="font-15 d-inline">{{ __('Phone Number') }}</h6>: {{ @$upcoming->user->student->phone_number }}</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @elseif($upcoming->type == 2)
                                                        <div class="booking-history-details-wrap d-flex align-items-center p-20">
                                                            <div class="booking-history-left">
                                                                ...
                                                                <p>{{ __('If you want to join online call. You need to create link using below meeting host.') }}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="align-items-center p-20">
                                                            <form action="{{ route('instructor.bookingMeetingStore', $upcoming->uuid) }}" method="post">
                                                                @csrf
                                                                <input type="hidden" class="topic" value="consultation">
                                                                <input type="hidden" class="date" value="{{ $upcoming->date }}">
                                                                <input type="hidden" class="duration" value="60">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="row mb-30 d-none zoom_live_link_div">
                                                                        <div class="col">
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-md-9">
                                                                                    <input type="text" name="start_url" class="form-control start_url" id="zoom_start_url{{ $upcoming->id }}"
                                                                            ...
                                                                            <div class="row align-items-center d-none">
                                                                                <div class="col-md-9">
                                                                                    <input type="hidden" name="join_url" class="form-control join_url" id="zoom_join_url{{ $upcoming->id }}"
                                                                                           placeholder="{{ __('Generate your live class link') }}"
                        ...
                        <div class="tab-pane fade {{ @$completedShowActive }}" id="past" role="tabpanel" aria-labelledby="past-tab">
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="table-data-with-img d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="instructor-student-img-wrap radius-50">
                                                            <img src="{{ getImageFile(@$completed->user->image_path) }}" alt="img" class="img-fluid"></div>
                                                    </div>
                                                    <div class="flex-grow-1 table-data-course-name">{{ @$completed->user->student->name }}</div>
                                                </div>
                                            </td>
                        ...
                        <div class="tab-pane fade {{ @$cancelledShowActive }}" id="cancelled" role="tabpanel" aria-labelledby="cancelled-tab">
                            <div class="table-responsive">
                                <table class="table booking-history-past-table">
                                    <thead>
                                    <tr>
                                    ...
                                    @foreach($bookingHistoryCancelled as $cancelled)
                                        <tr>
                                            <td>
                                                <div class="table-data-with-img d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="instructor-student-img-wrap radius-50">
                                                            <img src="{{ getImageFile(@$cancelled->user->image_path) }}" alt="img" class="img-fluid"></div>
                                                    </div>
                                                    <div class="flex-grow-1 table-data-course-name">{{ @$cancelled->user->student->name }}</div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="booking-table-detail-btn quiz-details-action-btns">
                                                    <button class="collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample{{ $cancelled->id }}" aria-expanded="false"
                                                            aria-controls="collapseExample1" title="See Details">
                                                        <span class="iconify" data-icon="fa6-solid:angle-down"></span>
                                                    </button>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="show-details-content">
                                            <td class="p-0" colspan="7">
                                                <div id="collapseExample{{ $cancelled->id }}" class="booking-history-details accordion-collapse collapse"
                                                     aria-labelledby="collapseExample{{ $cancelled->id }}" data-bs-parent="#accordionExample">
                                                    <div class="booking-history-details-wrap d-flex align-items-center p-20">
                                                        <div class="booking-history-left">
