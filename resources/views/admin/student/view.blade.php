                        ...
                        <div class="profile__table">
                            <table class="table-style">
                                ...
                                @foreach($enrollments as $enrollment)
                                    <tr>
                                        <td>
                                            <a href="{{route('admin.course.view', [@$enrollment->course->uuid])}}"><img src="{{ getImageFile(@$enrollment->course->image_path) }}" alt="course" class="img-fluid" width="80"></a>
                                        </td>
                                        <td>
                                            <span class="data-text"><a href="{{route('admin.course.view', [@$enrollment->course->uuid])}}">{{ @$enrollment->course->title }}</a></span>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
