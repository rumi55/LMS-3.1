...
Route::prefix('organizations')->as('organizations.')->group(function () {
    ...
    Route::post('change-organization-status', [OrganizationController::class, 'changeOrganizationStatus'])->name('changeOrganizationStatus')->middleware('isDemo');
    Route::get('delete/{uuid}', [OrganizationController::class, 'delete'])->name('delete')->middleware('isDemo');
    Route::get('create', [OrganizationController::class, 'create'])->name('create');
    Route::post('store', [OrganizationController::class, 'store'])->name('store')->middleware('isDemo');
});
...
Route::group(['prefix' => 'badge', 'as' => 'ranking.'], function () {
    ...
    Route::patch('update/{badge:uuid}', [RankingLevelController::class, 'update'])->name('update')->middleware('isDemo');
    Route::get('delete/{uuid}', [RankingLevelController::class, 'delete'])->name('delete')->middleware('isDemo');
    Route::post('refresh/distribute', [RankingLevelController::class, 'resetBadge'])->name('reset_badge')->middleware('isDemo');
});

Route::group(['prefix'=>'skills'],function(){
    Route::get('index', [SkillController::class, 'index'])->name('skill.index');
    Route::post('store', [SkillController::class, 'store'])->name('skill.store')->middleware('isDemo');
    Route::patch('update/{id}', [SkillController::class, 'update'])->name('skill.update')->middleware('isDemo');
    Route::get('delete/{id}', [SkillController::class, 'delete'])->name('skill.delete')->middleware('isDemo');
});
...
Route::prefix('language')->group(function () {
    ...
    Route::post('update/{id}', [LanguageController::class, 'update'])->name('language.update')->middleware('isDemo');;
    ...
    Route::post('update-language/{id}',[LanguageController::class, 'updateLanguage'])->name('update-language')->middleware('isDemo');
});
...
Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
    ...
    Route::post('device-control-changes', [SettingController::class, 'deviceControlChange'])->name('device_control.change')->middleware('isDemo');
    //End:: Device Control Mode

    //Start:: Device Control Mode
    Route::get('private-mode-changes', [SettingController::class, 'privateMode'])->name('private_mode');
    ...
    Route::post('subscription-mode-changes', [SettingController::class, 'subscriptionModeChange'])->name('subscription_mode.change')->middleware('isDemo');
    //End:: subscription Mode

    //Start:: saas Mode
    Route::get('saas-mode-changes', [SettingController::class, 'saasMode'])->name('saas_mode');
    Route::post('saas-mode-changes', [SettingController::class, 'saasModeChange'])->name('saas_mode.change')->middleware('isDemo');
    //End:: saas Mode
...
//    })->name('payouts');
    ...
    Route::post('referral-settings-update', [SettingController::class, 'referralSettingsUpdate'])->name('referral-settings.update')->middleware('isDemo');
